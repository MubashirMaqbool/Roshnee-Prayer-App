package com.roshneeprayer.Slider;
...
import com.roshneeprayer.Authentications.SignUp;
import com.roshneeprayer.Authentications.login;
...
public class OnBoardingActivity extends AppCompatActivity {
    ...
    Button button_login,getButton_signup;
...
public  void showSignUp(View view){
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // btn_get_started = (Button) findViewById(R.id.btn_get_started);
        ...
        imageView = (ImageView) findViewById(R.id.iv_onboard);
        button_login=findViewById(R.id.button_login);
        getButton_signup=findViewById(R.id.button_signup);
       // imageView_onbard=(ImageView)findViewById(R.id.iv_onboard);
        ...
        onboard_pager.setPageTransformer(true,new transformAnimation());
    ...
    public void loadData()
    {
        ...
        int[] imageId = {R.drawable.mosque, R.drawable.location,R.drawable.watch};
    ...
    {
        Animation show = AnimationUtils.loadAnimation(this, R.anim.slideup);
    ...
    {
        Animation hide = AnimationUtils.loadAnimation(this, R.anim.slidedown);
...
class transformAnimation implements ViewPager.PageTransformer{
    ...
    public void transformPage(@NonNull View page, float position) {
        ...
        page.setScaleY(1);
            ...
            float scale= (float) (2.0f +(1-2.0)*(1-Math.abs(position)));
